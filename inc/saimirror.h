...
typedef enum _sai_erspan_encapsulation_type_t
{
    ...
    /**
     * @brief L3 GRE Tunnel Encapsulation | L2 Ethernet header | IP header | GRE Extended header (RFC 2890) | Original mirrored packet
     */
    SAI_ERSPAN_ENCAPSULATION_TYPE_MIRROR_L3_GRE_TUNNEL_EXTENDED,
...
typedef enum _sai_mirror_session_attr_t
{
    ...
    /**
     * @brief GRE header reserved field. The first 16 bits of the GRE header.
     *
     * @type sai_uint16_t
     * @flags CREATE_AND_SET
     * @isvlan false
     ...
     * @validonly SAI_MIRROR_SESSION_ATTR_TYPE == SAI_MIRROR_SESSION_TYPE_ENHANCED_REMOTE
     */
    SAI_MIRROR_SESSION_ATTR_GRE_RESERVED_FIELD,
     ...
     * @flags CREATE_AND_SET
     * @default 0
     * @validonly SAI_MIRROR_SESSION_ATTR_ERSPAN_ENCAPSULATION_TYPE == SAI_ERSPAN_ENCAPSULATION_TYPE_MIRROR_L3_GRE_TUNNEL_EXTENDED
     */
    SAI_MIRROR_SESSION_ATTR_GRE_KEY,
